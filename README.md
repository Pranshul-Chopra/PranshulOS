...
- **Routines** - daily routines and weekly routine templates that user can manage and track their progress!

## What changed in v2.2
- **Routine Feature** - Routine Page and Weekly page for task templates that show on the table at the home page. Add a task and if you want their time slots and enjoy a routine template every day or every week!
- **Analytics** - weekly analytics for users to track their progressions on the home page and routine page for routine health check etc!
